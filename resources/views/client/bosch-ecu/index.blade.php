<x-layouts.client>
    ...
    <form method="GET" action="{{ route('client.bosch-ecu.index') }}" class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-6 flex flex-wrap items-end gap-4">
        <div>
        ...
        @if ($hasSearched)
            <a href="{{ route('client.bosch-ecu.index') }}" class="text-sm text-gray-500 dark:text-gray-400 hover:underline">Clear</a>
        @endif
    </form>
